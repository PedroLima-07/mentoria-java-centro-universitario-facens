# 🏋️‍♂️ Exercícios: Operadores em Ação

Chegou a hora de colocar a mão na massa! Crie os arquivos `.java` no seu VS Code para resolver cada um dos problemas abaixo. Lembre-se: errar faz parte do processo, então não tenha medo de testar!

---

### 🥖 Exercício 1: A Padaria (Operadores Aritméticos)

**Arquivo:** `Padaria.java`
...
4. Imprima no console o valor total e o troco.

> 💡 **Dica:** Lembre-se de usar `double` para valores com centavos!
...
3. Crie uma variável `boolean aprovado` que use operadores lógicos (`&&`) e relacionais (`>=`) para verificar se o aluno passou.
